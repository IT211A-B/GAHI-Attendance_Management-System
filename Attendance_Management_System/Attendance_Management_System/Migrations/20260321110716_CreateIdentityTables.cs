        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_User_Role", "\"Role\" IN ('admin', 'teacher', 'student')");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_AttendanceReport_ReportType", "\"ReportType\" IN ('daily', 'weekly', 'monthly', 'term')");
                    table.ForeignKey(
                        name: "FK_AttendanceReports_AcademicYears_AcademicYearId",
                        column: x => x.AcademicYearId,
                        principalTable: "AcademicYears",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AttendanceReports_AspNetUsers_GeneratedBy",
                        column: x => x.GeneratedBy,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AttendanceReports_Sections_SectionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Schedule_EndTime", "\"EndTime\" > \"StartTime\"");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SectionTeachers", x => new { x.SectionId, x.TeacherId });
                    table.ForeignKey(
                        name: "FK_SectionTeachers_Sections_SectionId",
                        column: x => x.SectionId,
                        principalTable: "Sections",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SectionTeachers_Teachers_TeacherId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Student_Gender", "\"Gender\" IN ('M', 'F', 'Other')");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DroppedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Enrollments", x => x.Id);
                    table.CheckConstraint("CK_Enrollment_Status", "\"Status\" IN ('pending', 'approved', 'rejected')");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttendanceReports_AcademicYearId",
                table: "AttendanceReports",
                column: "AcademicYearId");

            migrationBuilder.CreateIndex(
                name: "IX_AttendanceReports_GeneratedBy",
                table: "AttendanceReports",
                column: "GeneratedBy");

            migrationBuilder.CreateIndex(
                name: "IX_AttendanceReports_SectionId",
                table: "AttendanceReports",
                column: "SectionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Attendances_ScheduleId_StudentId_Date",
                table: "Attendances",
                columns: new[] { "ScheduleId", "StudentId", "Date" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SectionTeachers_TeacherId",
